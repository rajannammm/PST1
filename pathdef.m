...
p = [...
%%% BEGIN ENTRIES %%%
     'D:\Files\New folder\pest2code;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset);', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\ants;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\bees;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\beetle;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\catterpillar;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\earthworms;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\earwig;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\grasshopper;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\moth;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\slug;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\snail;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\wasp;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\agripestdata\weevil;', ...
     'D:\Files\New folder\pest2code\code(Agripestdataset)\subcodes;', ...
     'D:\Files\New folder\pest2code\code(IP102YOLOV5dataset);', ...
     'D:\Files\New folder\pest2code\code(IP102YOLOV5dataset)\IP102data;', ...
     'D:\Files\New folder\pest2code\code(IP102YOLOV5dataset)\subcodes;', ...
     'D:\Files\New folder\pest2code\code(coconutdataset);', ...
     'D:\Files\New folder\pest2code\code(coconutdataset)\coconutdata;', ...
     'D:\Files\New folder\pest2code\code(coconutdataset)\subcodes;', ...
     ...
     'C:\Users\RBMAS001\AppData\Roaming\MathWorks\MATLAB Add-Ons\Functions\Munkres Assignment Algorithm;', ...
     'C:\Users\RBMAS001\AppData\Roaming\MathWorks\MATLAB Add-Ons\Collections\Monarch Butterfly Optimization (MBO);', ...
%%% END ENTRIES %%%
     ...
];
...
if matlab.internal.feature('mpm')
    filetimestamp = 0x616E568026EDFu64;
